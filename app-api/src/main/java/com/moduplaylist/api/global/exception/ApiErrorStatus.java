...
public final class ApiErrorStatus {
    ...
    static {
        ...
        STATUS_MAP.put(ErrorCode.IMAGE_STORAGE_UNAVAILABLE, HttpStatus.SERVICE_UNAVAILABLE);
        ...
        // ai-playlist
        STATUS_MAP.put(ErrorCode.AI_PLAYLIST_GENERATION_FAILED, HttpStatus.SERVICE_UNAVAILABLE);
        STATUS_MAP.put(ErrorCode.AI_PLAYLIST_INVALID_CONTENT_RESULT, HttpStatus.BAD_GATEWAY);
        ...
        STATUS_MAP.put(ErrorCode.WATCHPARTY_ALREADY_JOINED_ELSEWHERE, HttpStatus.CONFLICT);
